...
dreamcar = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(
        text='Porsche', url='https://www.youtube.com/watch?v=Dt-0NVt6jSw', callback_data='911')],
    [InlineKeyboardButton(
        text='BMW', url='https://www.youtube.com/watch?v=RurHZGQtbmg', callback_data='m8')]

])
chelen = InlineKeyboardMarkup(inline_keyboard=[
    [InlineKeyboardButton(text="хочешь увеличить член?",
                          url='https://www.youtube.com/watch?v=vQC8jHwl6eY')]
])
